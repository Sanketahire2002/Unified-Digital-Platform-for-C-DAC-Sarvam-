          ...
          {filteredRows.length === 0 ? (
            ...
            currentRows.map((material, index) => (
              ...
              <tr key={material.id}>
                ...
                <td>
                  <button className="btn btn-danger btn-sm" onClick={() => handleDelete(material.id, material.fileName)}>
                    <BsTrash3Fill size={14} /> Delete
                  </button>
                </td>
                <td>
        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="moduleName" value={studyMaterial.moduleName} onChange={handleChange} />
            </Form.Group>
