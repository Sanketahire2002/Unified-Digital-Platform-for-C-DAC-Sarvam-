...
import InstructorMeetings from './InstructorMeetings';
import InstructorPlacements from './InstructorPlacements';
import InstructorQuiz from './InstructorQuiz';
import InstructorResults from './InstructorResults';
import InstructorSecurity from './InstructorSecurity';
import InstructorStaff from './InstructorStaff';
import InstructorSyllabus from './InstructorSyllabus';
    ...
    <div>
      <header className="bg-dark text-white fixed-top p-3 w-100">
        <div className="container-fluid d-flex align-items-center justify-content-between">
          ...
          <div className="d-flex justify-content-center flex-grow-1 align-items-center">
            <Link to="/go-to-instructor-dashboard/instructor-profile" className="d-flex align-items-center text-decoration-none">
              <img src={logo2} alt="Sanket Logo" width="40" height="40" className="me-2 rounded-circle" />
              <h3 className="m-0 fw-bold">I am Admin</h3>
            </Link>
          </div>
      ...
      <div className={`sidebar bg-dark text-white p-3 vh-100 ${sidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
        ...
        <div className={`sidebar-links ${sidebarOpen ? 'show-links' : ''}`}>
          ...
          <ul className="list-unstyled">
            <li><Link to="/go-to-instructor-dashboard/dashboard"><FaHome size={30} />{sidebarOpen && <span className="ms-2">Dashboard</span>}</Link></li>
            <li><Link to="/go-to-instructor-dashboard/instructor-syllabus"><FaBook size={30} />{sidebarOpen && <span className="ms-2">Syllabus</span>}</Link></li>
            <li><Link to="/go-to-instructor-dashboard/instructor-attendance"><FaClipboard size={30} />{sidebarOpen && <span className="ms-2">Attendance</span>}</Link></li>
            <li><Link to="/go-to-instructor-dashboard/instructor-assignment"><FaClipboardList size={30} />{sidebarOpen && <span className="ms-2">Assignment</span>}</Link></li>
            <li><Link to="/go-to-instructor-dashboard/instructor-materials"><FaClipboardCheck size={30} />{sidebarOpen && <span className="ms-2">Materials</span>}</Link></li>
            <li><Link to="/go-to-instructor-dashboard/instructor-quiz"><FaRegClipboard size={30} />{sidebarOpen && <span className="ms-2">Quiz</span>}</Link></li>
            <li><Link to="/go-to-instructor-dashboard/instructor-security"><FaUserLock size={30} />{sidebarOpen && <span className="ms-2">Security</span>}</Link></li>
            <li><Link to="/go-to-instructor-dashboard/instructor-meetings"><FaList size={30} />{sidebarOpen && <span className="ms-2">Meetings</span>}</Link></li>
            <li><Link to="/go-to-instructor-dashboard/instructor-feedback"><FaFileAlt size={30} />{sidebarOpen && <span className="ms-2">Feedback</span>}</Link></li>
            <li><Link to="/go-to-instructor-dashboard/instructor-results"><FaChartBar size={30} />{sidebarOpen && <span className="ms-2">Results</span>}</Link></li>
            <li><Link to="/go-to-instructor-dashboard/instructor-placements"><FaSuitcase size={30} />{sidebarOpen && <span className="ms-2">Placements</span>}</Link></li>
            <li><Link to="/go-to-instructor-dashboard/instructor-staff"><FaUsers size={30} />{sidebarOpen && <span className="ms-2">Staff</span>}</Link></li>
            <li><Link to="/go-to-instructor-dashboard/instructor-users"><FaUserCircle size={30} />{sidebarOpen && <span className="ms-2">Users</span>}</Link></li>
          </ul>
        </div>
      </div>
      ...
      <div className={`main-content p-4 flex-grow-1 ${sidebarOpen ? 'content-expanded' : 'content-collapsed'}`}>
        ...
        <Routes>
          ...
          <Route path="/instructor-syllabus" element={<InstructorSyllabus />} />
          ...
          <Route path="/instructor-staff" element={<InstructorStaff />} />
